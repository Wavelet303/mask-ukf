...
{
public:
    Validator2D(std::shared_ptr<PointCloudPrediction> point_cloud_prediction, const std::string& port_prefix, const std::string& camera_name, const std::string& camera_fallback_key);
